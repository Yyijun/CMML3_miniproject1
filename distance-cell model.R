# This code was adapted from https://learn.intl.zju.edu.cn/bbcswebdav/pid-126803-dt-content-rid-1813083_1/xid-1813083_1 provided by Prof. Luksys
...
if(pln > 0.5){
  ...
  latency_dc = latency
  ggplot(latency_dc,aes(day,latency))+geom_point()+ geom_smooth()+
